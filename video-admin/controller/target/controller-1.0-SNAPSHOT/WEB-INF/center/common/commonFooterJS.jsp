...
<input type="hidden" id="apiServer" name="apiServer" value="https://192.168.2.106:8080"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.2.106:9091/mvc"/>
